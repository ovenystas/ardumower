...
public:
  ...
  bool perimeterUse { false }; // use perimeter?
  ...
  bool trackingBlockInnerWheelWhilePerimeterStruggling;
  ...
  // ----- user-defined switch ---------------------------
  bool userSwitch1 { false }; // user-defined switch 1 (default value)
  bool userSwitch2 { false }; // user-defined switch 2 (default value)
  bool userSwitch3 { false }; // user-defined switch 3 (default value)
...
private:
  ...
  // ------------robot stats-----------------------------
  bool statsMowTimeTotalStart { false };
